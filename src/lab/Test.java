...
public class Test {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        UpperTriangularMatrix  m40 = null;
        int[][] temp13 = {{1,1,1,1,1,1},{0,2,2,2,2,2},{0,0,3,3,3,3},{0,0,0,4,4,4},{0,0,0,0,5,5},{0,0,0,0,0,6}};
        Matrix mm10 = new Matrix(temp13);
        m40 = new UpperTriangularMatrix(mm10);
        double[] bb10 = {2,3,4,5,6};
        
        try{
            System.out.println(Arrays.toString(m40.effSolve(bb10)) + "\n");
        }
        catch (IllegalArgumentException e){
            System.out.println(e);
            System.out.println("");
